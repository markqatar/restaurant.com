                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center py-3">
                            <div class="position-relative mb-3">
                                <img src="<?php echo $siteUrl; ?>/assets/images/avatars/<?php echo htmlspecialchars($data['preferences']['avatar'] ?? 'default.png'); ?>" 
                                     alt="User Avatar" class="rounded-circle p-1 bg-primary" width="110" height="110"
                                     onerror="this.src='<?php echo $siteUrl; ?>/assets/images/avatars/default.png'">
                            </div>
                            <div class="mt-3">
