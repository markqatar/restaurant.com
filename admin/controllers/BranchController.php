...
class BranchController {
    ...
    public function create() {
        ...
        // Since states table was removed, provide a static list of states
        $states = [
            'CA' => 'California',
            'NY' => 'New York', 
            'TX' => 'Texas',
    ...
    public function store() {
        ...
        if ($_POST) {
            ...
            if (!verify_csrf_token($_POST['csrf_token'])) {
                ...
                redirect('branches.php?action=create');
            }
    ...
    public function edit($id) {
        ...
        if ($branch['state_id']) {
            $cities = $this->branch_model->getCitiesByState($branch['state_id']);
        }
