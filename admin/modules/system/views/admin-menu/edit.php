            ...
            <div class="card border-top border-0 border-4 border-warning">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-warning"><?php echo TranslationManager::t('edit.menu.item'); ?></h5>
                    </div>
                    <hr/>
                    ...
                    <form method="POST" action="<?php echo get_setting('site_url', 'http://localhost'); ?>/admin/menu-management/update/<?php echo $menu_item['id']; ?>">
