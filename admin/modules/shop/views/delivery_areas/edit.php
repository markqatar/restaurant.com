...
if (!isset($_SESSION['user_id']) || !has_permission($_SESSION['user_id'], 'delivery_areas', 'update')) {
...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <h1 class="h2">
        <i class="fas fa-map-marker-alt me-2"></i><?php echo TranslationManager::t('edit_delivery_area'); ?>
    </h1>
...
<!-- Form modifica Delivery Area -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><?php echo TranslationManager::t('edit_delivery_area'); ?></h6>
    </div>
    <div class="card-body">
        <form method="POST" action="<?php echo get_setting('site_url', 'http://localhost') . '/admin/shop/deliveryarea/update/' . $data['id']; ?>">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="area_name"
                               name="area_name"
                               value="<?php echo htmlspecialchars($_POST['area_name'] ?? $data['area_name']); ?>"
                        ...
                        <select class="form-select" id="shop_id" name="shop_id" required>
                            ...
                            <?php foreach ($branches as $branch): ?>
                                <option value="<?php echo $branch['id']; ?>"
                                    <?php echo ((isset($_POST['branch_id']) ? $_POST['branch_id'] : $data['branch_id']) == $branch['id']) ? 'selected' : ''; ?>>
            ...
            <div class="d-flex justify-content-end mt-3">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i><?php echo TranslationManager::t('update'); ?>
                </button>
            </div>
        </form>
    </div>
