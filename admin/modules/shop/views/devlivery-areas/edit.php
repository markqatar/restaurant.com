...
if (!isset($_SESSION['user_id']) || !hasPermission('edit_delivery_areas')) {
...
$id = $_GET['id'] ?? null;
if (!$id) {
    header('Location: delivery-areas.php?error=' . urlencode(translate('invalid_request')));
    exit;
}
...
$pageTitle = translate('edit_delivery_area');
        ...
        <div class="col-md-10">
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><?php echo translate('edit_delivery_area'); ?></h2>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="area_name" name="area_name" 
                                               value="<?php echo htmlspecialchars($_POST['area_name'] ?? $data['deliveryArea']['area_name']); ?>" 
                                        ...
                                        <select class="form-select" id="shop_id" name="shop_id" required>
                                            ...
                                            <?php foreach ($data['branches'] as $branch): ?>
                                                <option value="<?php echo $branch['id']; ?>" 
                                                        <?php echo (isset($_POST['shop_id']) ? $_POST['shop_id'] : $data['deliveryArea']['shop_id']) == $branch['id'] ? 'selected' : ''; ?>>
