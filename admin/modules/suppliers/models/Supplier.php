...
class Supplier
{
    ...
    public function create($data)
    {
        $query = "INSERT INTO " . $this->table . " 
              (name, address_line1, address_line2, zip_code, country_id, city_id, tel1, tel2, email1, email2, notes, is_active) 
              VALUES (:name, :address_line1, :address_line2, :zip_code, :country_id, :city_id, :tel1, :tel2, :email1, :email2, :notes, :is_active)";
