...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><?php echo t('user.permissions'); ?></h6>
    </div>
    <div class="card-body">
                        ...
                        <?php foreach ($permissions as $permission): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="text-muted"><?php echo t('msg.no_data'); ?></span>
                                    <?php endif; ?>
                                </td>
