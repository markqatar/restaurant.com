...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo get_setting('site_url', 'http://restaurant.com') . '/admin/users/store'; ?>" id="userForm">
                    <input type="hidden" name="csrf_token" value="<?php echo get_csrf_token(); ?>">

                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="username" class="form-label"><?php echo t('user.username'); ?> *</label>
                                <input type="text" class="form-control" id="username" name="username" required>
                                <div class="form-text"><?php echo t('user.username'); ?> <?php echo t('form.required'); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="first_name" class="form-label"><?php echo t('user.first_name'); ?> *</label>
                                <input type="text" class="form-control" id="first_name" name="first_name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="last_name" class="form-label"><?php echo t('user.last_name'); ?> *</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text"><?php echo t('form.required'); ?> - <?php echo t('form.enter_value'); ?> (min 6 <?php echo t('form.required'); ?>)</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text"><?php echo t('inactive'); ?> <?php echo t('users'); ?> <?php echo t('user.password_note'); ?></div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i><?php echo t('create'); ?> <?php echo t('user.new_user'); ?>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 small">
                        ...
                        <li><?php echo t('user.username'); ?> <?php echo t('form.required'); ?></li>
                        <li>Password <?php echo t('form.required'); ?> (min 6)</li>
                        <li><?php echo t('user.groups'); ?> <?php echo t('form.optional'); ?></li>
                    </ul>
                </div>

                <div class="alert alert-warning">
                    <h6><i class="fas fa-exclamation-triangle me-1"></i><?php echo t('msg.warning'); ?></h6>
                    <p class="mb-0 small">
                        <?php echo t('user.password_note'); ?>
                    </p>
                </div>
            </div>
        </div>
